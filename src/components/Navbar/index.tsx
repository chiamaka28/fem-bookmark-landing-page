  ...
  return (
    <div className='flex justify-between items-center py-6 px-5'>
      ...
      <div
        ...
        }   min-h-full bg-dark-blue z-50 w-full opacity-[0.95] backdrop-blur-16 text-white `}
      >
        <div className='flex justify-between items-center py-6 px-5'>
          <button>
        ...
        <div className='flex flex-col items-center gap-4 text-[20px] pt-4 w-[90%] mx-auto '>
          <ul className='flex flex-col items-stretch w-full text-center  font-normal '>
            <li className='border-b border-t  border-white border-opacity-[0.15] py-4'>
              <a href=''>FEATURES</a>
            </li>
            <li className='border-b  border-white border-opacity-[0.15] py-4'>
              <a href=''>PRICING</a>
            </li>
            <li className='border-b  border-white border-opacity-[0.15] py-4'>
              <a href=''>CONTACT</a>
          ...
          <div className='font-medium border-2 py-2 my-2 border-white w-full rounded-[5px] flex justify-center items-center'>
            <a href=''>LOGIN</a>
          </div>
        </div>
      </div>
